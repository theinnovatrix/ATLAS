...
CAPABILITIES: tuple[Capability, ...] = (
    ...
    Capability("system_diagnostics", "system", "Check system-control dependencies.", implemented=True),
    ...
    Capability("lock_screen", "system", "Lock screen.", RiskLevel.CONFIRM, True),
    Capability("screenshot", "system", "Take a screenshot.", RiskLevel.CONFIRM, True),
    Capability("service_status", "system", "Check systemd service status.", implemented=True),
    ...
    Capability("notifications", "system", "Manage alerts.", RiskLevel.CONFIRM, True),
    ...
    Capability("copy_path", "desktop", "Copy file path.", implemented=True),
    Capability("zip_files", "desktop", "Compress files.", RiskLevel.CONFIRM, True),
    Capability("unzip_files", "desktop", "Extract zip files.", RiskLevel.CONFIRM, True),
    ...
    Capability("git_status", "developer", "Git status summary.", implemented=True),
    ...
    Capability("json_validator", "developer", "Validate JSON.", implemented=True),
    Capability("safe_shell", "developer", "Suggest safe shell commands.", implemented=True),
    Capability("shell_suggest", "developer", "Suggest safe shell commands.", implemented=True),
    ...
    Capability("daily_news", "web", "Read news.", implemented=True),
    Capability("play_music", "media", "Play music.", RiskLevel.CONFIRM),
    Capability("youtube_metadata", "web", "Prepare YouTube metadata lookup.", implemented=True),
    Capability("play_video", "media", "Play YouTube videos.", RiskLevel.CONFIRM),
    Capability("find_images", "web", "Search images."),
    Capability("page_summary", "web", "Summarize public webpages.", implemented=True),
    ...
    Capability("stock_prices", "web", "Check stocks.", implemented=True),
    Capability("page_summary", "web", "Summarize public web pages.", implemented=True),
    ...
    Capability("website_summary", "web", "Summarize public webpages.", implemented=True),
